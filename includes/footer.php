            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="tmp-footer-widget">
                        <div class="logo">
                            <a href="index.html">
                                <img class="logo-light" src="assets/images/logo/construction-logo.svg" alt="Corporate Logo">
                                <img class="logo-dark" src="assets/images/logo/construction-logo-dark.svg" alt="Corporate Logo">
                            </a>
                        </div>
