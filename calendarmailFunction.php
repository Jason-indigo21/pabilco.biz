...
elseif (!checkRateLimit()) {
    ...
    $inputs = array(
        ...
        'appointment-date' => filter_var($_POST['appointment-date'], FILTER_SANITIZE_STRING),
        'appointment-time' => filter_var($_POST['appointment-time'], FILTER_SANITIZE_STRING),
    ...
    elseif (detectSpam($inputs['message'], $inputs['name'])) {
        ...
        $appointmentDate = $inputs['appointment-date'];
        $appointmentTime = $inputs['appointment-time'];
        ...
        $formContent = "<b>Name: </b>" . htmlspecialchars($name) .
            ...
            "<br><b>Appointment Date: </b>" . htmlspecialchars($appointmentDate) .
            "<br><b>Appointment Time: </b>" . htmlspecialchars($appointmentTime) .
